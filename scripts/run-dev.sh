...
# GOVC_* 환경 변수가 우선, 없으면 VCENTER_* 사용
GOVC_URL="${GOVC_URL:-${VCENTER_URL:-https://vc.danacloud.local}}"
...
# VCENTER_* 변수도 설정 (하위 호환성)
VCENTER_URL="${VCENTER_URL:-${GOVC_URL:-https://vc.danacloud.local}}"
VCENTER_USERNAME="${VCENTER_USERNAME:-${GOVC_USERNAME:-Administrator@VSPHERE.LOCAL}}"
VCENTER_PASSWORD="${VCENTER_PASSWORD:-${GOVC_PASSWORD:-VMware1!}}"
...
echo "    vCenter URL: ${GOVC_URL:-${VCENTER_URL:-not set}}"
echo "    vCenter User: ${GOVC_USERNAME:-${VCENTER_USERNAME:-not set}}"
